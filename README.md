...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create chadslab-app-b52d
  fly apps create chadslab-app-b52d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app chadslab-app-b52d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app chadslab-app-b52d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'chadslab-app-b52d-staging' does not match app name in config file 'chadslab-app-b52d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name chadslab-app-b52d-db
  fly postgres attach --app chadslab-app-b52d chadslab-app-b52d-db

  fly postgres create --name chadslab-app-b52d-staging-db
  fly postgres attach --app chadslab-app-b52d-staging chadslab-app-b52d-staging-db
  ```
